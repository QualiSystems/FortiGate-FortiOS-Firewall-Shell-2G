...
from cloudshell.firewall.fortinet.runners.autoload_runner import FortiNetAutoloadRunner as \
    AutoloadRunner
...
from cloudshell.firewall.fortinet.snmp.snmp_handler import FortiNetSnmpHandler as SnmpHandler
...
class FortiGateFortiOSFirewallShell2GDriver(
    ...
    def initialize(self, context):
        ...
        :param cloudshell.shell.core.driver_context.InitCommandContext context: the context the
            command runs on
        """
    ...
    def restore(self, context, path, configuration_type, restore_method):
        ...
        :param cloudshell.shell.core.driver_context.ResourceCommandContext context: The context
            object for the command with resource and reservation info
